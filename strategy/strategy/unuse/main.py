...
if __name__ == '__main__':
    ...
    try:
        ...
        logging.debug("Successfully pickled cerebro instance to file (%s)!" % pickle_file_path)
    except:
        logging.exception("Failed to pickle cerebro instance to file (%s)" % pickle_file_path)
